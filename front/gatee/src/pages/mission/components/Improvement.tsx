    ...
    <div className="improvement-card">
      <div>
        ...
        <div className="flex-row">
          <button onClick={() => navigate(content[type].destination)}
                  className="improvement-card-button">{content[type].buttonComment}</button>
